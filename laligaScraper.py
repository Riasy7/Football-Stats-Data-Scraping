...
----------------------------------------
This script scrapes data from fbref.com for all teams in the Spanish LaLiga.
...
----------------------------------------
This code is also used for Premier League, and can be used for other leagues as well.
"""
...
html = requests.get('https://fbref.com/en/comps/12/stats/La-Liga-Stats').text # Retrieve HTML content from the URL
...
stat_df.to_csv("laliga_stats.csv") # Save the DataFrame to a CSV file